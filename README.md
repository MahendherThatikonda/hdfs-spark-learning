...
Bash scripting — automating HDFS operations via shell commands
Java — MapReduce API, input/output formatting
Big Data concepts — distributed storage, parallel processing, fault tolerance
